...
int gen_f_pc()
{
    return ((((ex_mem_curr->icode) == (I_JMP)) & !(ex_mem_curr->takebranch)
        ) ? (ex_mem_curr->vala) : ((((((ex_mem_curr->icode) == (I_RMMOVL))
               & ((if_id_curr->icode) == (I_JMP))) & ((if_id_curr->ifun)
               == 1)) & !(ex_mem_curr->takebranch)) & !((id_ex_curr->icode)
           == (I_ALU) || (id_ex_curr->icode) == (I_IADDL))) ? 
      (if_id_curr->valp) : (((if_id_curr->icode) == (I_RET)) & (
          (id_ex_curr->icode) == (I_PUSHL))) ? (id_ex_curr->vala) : (
...
int gen_f_ifun()
{
    return ((imem_error) ? (F_NONE) : ((if_id_next->icode) == (I_RMMOVL))
       ? 1 : (imem_ifun));
}
...
int gen_F_stall()
{
    return (((((id_ex_curr->icode) == (I_MRMOVL) || (id_ex_curr->icode) == 
            ...
            (if_id_curr->icode)) & ((I_PUSHL) != (id_ex_curr->icode)))) | (
    ...
    return ((((id_ex_curr->icode) == (I_JMP)) & !(ex_mem_next->takebranch))
       | (!(((id_ex_curr->icode) == (I_MRMOVL) || (id_ex_curr->icode) == 
            ...
            (id_ex_curr->icode) || (I_RET) == (ex_mem_curr->icode)) | ((
              (I_RET) == (if_id_curr->icode)) & ((I_PUSHL) != 
              (id_ex_curr->icode))))));
}
...
int gen_E_bubble()
{
    return ((((((id_ex_curr->icode) == (I_JMP)) & !
            ...
            (I_PUSHL)))) | (((((ex_mem_curr->icode) == (I_RMMOVL)) & (
              (if_id_curr->icode) == (I_JMP))) & ((if_id_curr->ifun) == 1))
