...
##          Description of IIADDL             Description of ILEAVE
##  F:       icode:ifun <- M1[PC]              icode:ifun <-M1[PC]                            
##           rA:rB <- M1[PC+1]                 valP <- PC + 1
##           valC <- M4[PC+2]
##           valP <- PC + 6
##  D:       valB <- R[rB]                     valA <- R[%ebp]
##                                             valB <- R[%ebp]
##  E:       valE <- valB + valC               valE <- valB + 4 
##           Set CC  
##  M:                                         valM <- M4[valA]
##  W:       R[rB] <- valE                     R[%esp] <- valE
##                                             R[%ebp] <- valM
##  P:       PC <- valP                        PC <- valP      
####################################################################
